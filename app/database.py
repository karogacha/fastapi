...
SQLALCHEMY_DATABASE_URL = f'mssql://{settings.database_username}:{settings.database_password}@{settings.database_server}/{settings.database_name}?encoding=utf-8&azure=true'
