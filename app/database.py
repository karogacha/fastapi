...
SQLALCHEMY_DATABASE_URL = f'mssql+pyodbc://{settings.database_username}:{settings.database_password}@{settings.database_server}/{settings.database_name}?driver=ODBC+Driver+18+for+SQL+Server'
